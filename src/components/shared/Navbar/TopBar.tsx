  ...
  return (
    <div
      ...
      className={cn(
        ...
        isScrolling ? "bg-primary/50 backdrop-blur-md" : "bg-primary"
      )}
    >
      <nav className="w-[90%] md:w-[90%] lg:w-[70%] layout_normal flex items-center justify-between gap-x-5 px-2">
        ...
        <div className="w-1/3 flex justify-center">
          <time className="text-para4 text-">EST - 2015</time>
        </div>
      ...
      <nav
        className={cn(
          "fixed left-0 top-0 bottom-0 z-20 pxX-[6%] w-full h-screen  backdrop-blur-[6px] transition-all duration-500 ease-in-out",
          `bg-[url("/assets/mask_bg/bg_mask.png")] ${isOpen ? "opacity-100 visible translate-x-0" : "opacity-0 invisible translate-x-full"}`
        )}
      >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 text-typo-primary ">
            <aside className="flex flex-col justify-center md:min-h-screen border-b-[0.5px] md:border-b-0 md:border-r-[0.5px] border-mute flex-grow pb-4 lg:pb-0">
              <div className="w-full md:w-[70%] lg:w-[65%] xl:w-[45%] mx-auto">
                <div>
                  <Button
                    className="w-[30%] h-[1.5rem] rounded-full px-10  hover:bg-btn_hvr hover:text-typo-primary "
                    variant={"outline"}
                  >
                    Let&lsquo;s Talk
                  </Button>
                ...
                <ul className="flex justify-between gap-2 mt-8">
                  <li>
                    <div className="uppercase text-[1rem] md:text-[calc(100vw/60)]  lg:text-[calc(100vw/60)] xl:text-[calc(50vw/45)] font-helvetica font-normal ">
                      Phone
                    </div>
                    <div className="text-[1rem] md:text-[calc(100vw/60)] lg:text-[calc(100vw/60)] xl:text-[calc(50vw/45)] font-helvetica mt-[0.9rem]">
                      +1 (415)-800-2326
                    </div>
                  </li>
                  <li>
                  ...
                  <li>
                    <div className="uppuppercase text-[1rem] md:text-[calc(100vw/60)] lg:text-[calc(100vw/60)] xl:text-[calc(50vw/45)] font-helvetica font-normalercase ">
                      Blog
                    </div>
                    <div className="mt-2">
                      <LuArrowUpRight
                        className="xl:w-[calc(50vw/30)]"
                        size={40}
                      />
                    </div>
                  </li>
            ...
            <aside className="flex flex-col justify-center">
              <div className="md:pl-16 md:pr-[2vw]">
                <div className="md:relativeX">
                  <div
                    className="absolute z-[1] top-0 md:top-3 md:right-6 lg:top-12 lg:right-12 right-0  cursor-pointer"
                    onClick={handleOpen}
                  >
                    <TfiClose
                ...
                <div className=" mt-0">
                  <p
                    className="text-[2.5rem] lg:text-[2rem] xl:text-[3.5rem] font-clash cursor-pointer text-typo-primary"
                  ...
                  <p
                    className="text-[2.5rem] lg:text-[2rem] xl:text-[3.5rem] font-clash cursor-pointer text-typo-primary"
                    onClick={() => handleNavigation("/the-motif-process")}
                  >
                    How We Do
                  </p>
                  <p
                    className="text-[2.5rem] lg:text-[2rem] xl:text-[3.5rem] font-clash cursor-pointer text-typo-primary"
                    onClick={() => handleNavigation("/why-motif")}
                  >
                    Why <span className="font-bold">MOTIF</span>{" "}
                    <span className="text-head5">®</span> ?{" "}
                  </p>
                  <p
                    className="text-[2.5rem] lg:text-[2rem] xl:text-[3.5rem] font-clash cursor-pointer text-typo-primary"
