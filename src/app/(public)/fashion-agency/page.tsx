...
const pageData = {
    heading: [
        [ "Cultivating" ,"hyper", "growth"," for" ,"fashion", "brands" ,
            { imageSrc: "/assets/fashion_agency/fashionTitleImage.png", altText: "fashion image" },
        ],
    ],
    heading_description: [
        "Motif® is a global advertising and strategic branding agency helping Fashion brands grow exponentially across the globe by connecting them with end users with better marketing, branding & exceptional customer experience."
    ],
    ads: ["Advertising", "Strategy","BRANDING", "MARKETING", "DESIGN", "CXO"],
    faq_description: [
        "As a luxury fashion marketing" ,
        "and branding agency who are" ,
        "on performance, we’re here to" ,
        "make sure you succeed on all",
        "fronts.",
    ],
    faqs: [
        {
            title: "Strategy for hyper-growth",
            description: [
                {
                    text:"An airtight eCommerce strategy is crucial to set your luxury fashion brand up for success. Our eCommerce experts work with you to understand your niche industry— from your target market and competitors, to what your brand’s mission is."
                },
                {
        ...
        {
            title: "Fashion branding for success",
            description: [
                {
                    text: "You need to position yourself and who your brand is so that you can deliver a unique experience that customers can recognize instantly. We work with you to figure out who you are as a brand and how you need to present yourself to create a lasting impact."

                },
                {
                    text:"Our proven method has helped luxury brands like yours build a story around their brand, increase their visibility and recall."
                }
            ]
        },
        {
            title: "User focused experience design",
            description: [
                {
                ...
                {
                    text:"We work with you to conceptualize your design, build wireframes, and collaborate on finalizing a winning store design. We then develop this store design, ensuring that it is mobile responsive and is easy for shoppers to navigate through."
                },
                {
        ...
        {
            title: "Fashion brand marketing strategy",
            description: [
                {
                    text: "Just setting up your brand’s storefront isn’t enough. We work with you closely to set up a successful luxury brand marketing strategy, based on your brand’s target audience and using tried and tested marketing channels.",
                },
                {
                    text:"Besides strategizing and implementing on our marketing plan, we also help you predict the revenue you could generate from different marketing channels. We are full stack marketing experts, from social media management, to email marketing to paid efforts."
                },
                {
        ...
        },
        {
            ...
            description: [
                {
                    text:"As a DTC &  luxury fashion branding agency, we are well-versed in different platforms available for your luxury fashion brand."
                },
                {
                    text:"If you outgrow your current eCommerce platform, we're here to help you choose a better alternative and do your site migration for you. During migration, we ensure that your data is in one place and ensure that you have all the resources you need to get started on the new platform."
                },
                {
