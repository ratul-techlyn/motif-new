...
const pageData = {
    heading: [
        [  "Shaping" ,"the", "future" ,"of" ,"a","Brand","Growth", "as", "a" ,"DTC","Agency",
            { imageSrc: "/assets/beauty/beautyTitleImage.jpg", altText: "Beauty image" },
        ],
    ],
    heading_description: [
        "As full service DTC Branding & Marketing agency who build, grow and scale Direct to consumer lifestyle, fashion and beauty brands with the right strategies & powerful creatives.dt"
    ],
    ads: ["Advertising", "Strategy","BRANDING", "MARKETING", "DESIGN", "CXO"],
    faq_description: [
        "As a Performance focused" ,
        "Direct To Consumer Agency" ,
        "our sole purpose is to make" ,
        "sure you succeed on all",
        "fronts.",
    ],
    faqs: [
        {
