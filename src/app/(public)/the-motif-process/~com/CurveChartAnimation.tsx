...
const CurveChartAnimation = () => {
  ...
  useEffect(() => {
    ...
    script.onload = () => {
    if (mounted) {
      // load the gsam DrawSVGPlugin library before initialize
        ...
        <div className="chart_btn_wrapper">
          ...
          >
            <div className="content_card">
              ...
              <p className="pera">
                After you apply to be a partner with MOTIF, one of our brand
                strategist will jump on a free strategy session with your key
                stake holders. We&apos;ll dive into your brand, current situations, &
                goals to help you succeed. If we are a great fit for each others
                we will move forward.
              </p>
            </div>
          </div>
          <div
            className="btn_box tow"
          ...
          >
            <div className="content_card">
              ...
              <p className="pera">
                Based on our previous stage if we will able to help we&apos;ll move
                to the next stage. We&apos;ll create a one-of-a-kind roadmap and the
                right strategy with a laser-focused objective. It&apos;s designed to
                be effortlessly embraced, and will start producing tangible
                results.
              </p>
            </div>
          </div>
          <div
            className="btn_box three"
          ...
          >
            <div className="content_card">
              ...
              <p className="pera">
                After shaping the roadmap, we roll up our sleeves for the next
                step. We&apos;ll make your eCommerce marketing look and feel just
                right, in line with your brand. Plus, we&apos;ll put lots of data to
                work – Google Analytics, heat mapping, and tracking – so you
                keep getting the best results.
              </p>
            </div>
          </div>
          <div
            className="btn_box four"
          ...
          >
            <div className="content_card">
              ...
              <p className="pera">
                In our first 90 days, we craft, test, and refine. We’re your
                performance stewards, optimizing as we sail. With data in hand,
                we set revenue goals, aiming for a winning ROI and lasting
                customer value. We&apos;re a team of strategists, marketers &
                technologists who are focused on delivering results.
              </p>
            </div>
          </div>
          <div
            className="btn_box five"
          ...
          >
            <div className="content_card">
              ...
              <p className="pera">
                After the initial 90 days, we regroup to fine-tune our goals. We
                analyze the recent data and collaboratively set revenue targets
                and marketing budgets by channels. Our aim is to set achievable
                objectives and work diligently to meet them. We&apos;re true
                partners, committed to maximizing results.
              </p>
            </div>
          </div>
        </div>
