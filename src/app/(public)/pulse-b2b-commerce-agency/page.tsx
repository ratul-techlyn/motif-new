...
const pageData = {
  heading: [
    [ "growing"," and","scaling"," b2b", "ecommerce"," brands",
      { imageSrc: "/assets/pulseB2B/pulse_b2b.webp", altText: "brand image" },
    ],
  ],
  heading_description: [
    "PulseB2B is one of our signature team initiative who helps B2B ecommerce brands to grow and scale faster with the marketing strategies customer experience design & powerful creatives.",
  ],
  ads: [
    "CONNECTING", "BRAND",
    "WITH",
  ...
  faq_description: [
    "As an expert business to",
    "business commerce agency our",
    "sole purpose is to make sure",
    "you succeed on all fronts.",
  ],
  faqs: [
    {
      title: "DTC strategy",
    ...
    {
      title: "DTC branding to succeed",
      description: [
        {
          text: "Your positioning is a crucial part of what makes you stand out as a DTC brand. The right branding can help you deliver a unique experience that customers can recognize instantly. We work with you to figure out who you are as a brand and how you need to present yourself to create a lasting impact and break status quo.",
        },
        {
          text: "Our proven method has helped DTC brands like yours build a narrative around their brand, increasing their visibility and recall. ",
        },
      ],
    },
    {
    ...
    {
      title: "DTC brand marketing",
      description: [
        {
          text: "Once your storefront is set up, it’s time to ensure you start capturing sales. We work with you closely to set up a successful DTC brand marketing strategy, based on your brand’s target audience and using tried and tested marketing channels.  ",
        },
        {
          text: "Besides strategizing and implementing our thorough marketing plan, we also help you predict the revenue you could generate from different marketing channels. As full-stack marketing experts and DTC Agency, we manage all your different channels— from social media to email marketing to paid efforts.",
        },
        {
          list: [
            {
    ...
    },
    {
      ...
      description: [
        {
          text: "As a DTC Marketing and Growth Agency we don’t just set up our strategy and walk away. We are invested in the results you receive and how we can improve the existing strategy. We stay in touch with you and keep an eye on changing consumer trends within the cosmetics and beauty industry to optimize the work we've done. ",
        },
        {
